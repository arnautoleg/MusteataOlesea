...
sample_size <- 400 # Количество животных, прошедших, терапию
...
mean2 = 20 # Истинная средняя биомаркера в группе терапии B
...
# Формируем выборку
n1 = 5    # Количество животных в группе терапии А
n2 = 3    # Количество животных в группе терапии B
...
print(diffscoreci(sum(sample1), sample_size, sum(sample2), sample_size,
            conf.level=0.95))


print(wald2ci(sum(sample1), sample_size, sum(sample2), sample_size,
        conf.level=0.95,
        adjust = "Wald"))
