...
# Values of x for which you want to calculate the probabilities
x_values <- 0:n

# Calculate the probabilities for each x value
probabilities <- dbinom(x_values, size = n, prob = p)

# Create a bar plot to visualize the binomial distribution
barplot(probabilities, names.arg = x_values, xlab = "Number of Successes (x)", ylab = "Probability")

# Add a title to the plot
title(main = "Binomial Probability Distribution")
