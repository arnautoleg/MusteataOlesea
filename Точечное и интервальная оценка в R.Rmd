...
# # Sample data for two independent samples (replace with your own data)
# set.seed(123)
# mean1 = 20
# mean2 = 20
# n1 = 100
...
# 
# # Extract the confidence interval for the difference of means (asymptotic method)
...
# 
# # Perform exact two-sample t-test
# exact_t_test_result <- t.test(data1, data2, conf.level = confidence_level, var.equal = TRUE)
# 
# # Extract the confidence interval for the difference of means (exact method)
...
# # Perform bootstrapping
# set.seed(123)  # Set seed for reproducibility
# boot_results <- boot(combined_data, statistic_function, R = 1000)  # R is the number of bootstrap samples
# 
# # Calculate bootstrap confidence interval
...
# 
# # Print the results
# cat("Asymptotic Method (Z-interval):", ci_diff_means_asymptotic, "Ширина:", width_asymptotic, "\n")
# cat("Exact Method (t-interval):", ci_diff_means_exact, "Ширина:", width_exact, "\n")
# cat("Bootstrap Method:", ci_diff_means_bootstrap, "Ширина:", width_bootstrap, "\n")
